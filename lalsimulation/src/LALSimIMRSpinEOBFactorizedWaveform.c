...
UNUSED static int XLALSimIMREOBCalcPrecSpinFacWaveformCoefficients(
          FacWaveformCoeffs * const coeffs,
          const REAL8               m1,
          const REAL8               m2,
          const REAL8               eta,
   ...
   status = XLALSimIMRSpinEOBCalculateNewtonianMultipole( &hNewton, vPhi2, r,
	...
	switch( l )
	{
	    ...
	    switch( abs(m) )
	    {
	      case 2:
	        deltalm = vh3*(hCoeffs->delta22vh3 
                    + vh3*((hCoeffs->delta22vh6 + hCoeffs->delta22vh6S)
                    + vh*vh*(hCoeffs->delta22vh9*vh)))
                    + hCoeffs->delta22v5 *v*v2*v2 
                    + (hCoeffs->delta22v6 + hCoeffs->delta22v6S)*v2*v2*v2 
                    + (hCoeffs->delta22v8 + hCoeffs->delta22v8S)*v2*v2*v2*v2;
            rholm	= 1. + v2*(hCoeffs->rho22v2 
                + v*((hCoeffs->rho22v3 + hCoeffs->rho22v3S)
                + v*((hCoeffs->rho22v4 + hCoeffs->rho22v4S)
                + v*((hCoeffs->rho22v5 + hCoeffs->rho22v5S)
                + v*((hCoeffs->rho22v6 + hCoeffs->rho22v6S)
                + hCoeffs->rho22v6l*eulerlogxabs 
                + v*((hCoeffs->rho22v7 + hCoeffs->rho22v7S)
                + v*((hCoeffs->rho22v8 + hCoeffs->rho22v8S)
                + hCoeffs->rho22v8l*eulerlogxabs 
                + (hCoeffs->rho22v10 + hCoeffs->rho22v10l * eulerlogxabs)*v2)))))));
	        break;
	      case 1:
                {
	        deltalm = vh3*(hCoeffs->delta21vh3 
                        + vh3*((hCoeffs->delta21vh6 + hCoeffs->delta21vh6S)
			+ vh*((hCoeffs->delta21vh7 + hCoeffs->delta21vh7S) 
                        + (hCoeffs->delta21vh9)*vh*vh))) 
			+ hCoeffs->delta21v5*v*v2*v2 + hCoeffs->delta21v7*v2*v2*v2*v;
		rholm	= 1. + v*(hCoeffs->rho21v1
			+ v*((hCoeffs->rho21v2 + hCoeffs->rho21v2S)
                        + v*((hCoeffs->rho21v3 + hCoeffs->rho21v3S)
                        + v*((hCoeffs->rho21v4 + hCoeffs->rho21v4S)
			+ v*((hCoeffs->rho21v5 + hCoeffs->rho21v5S)
                        + v*((hCoeffs->rho21v6 + hCoeffs->rho21v6S)
                        + hCoeffs->rho21v6l*eulerlogxabs 
			+ v*((hCoeffs->rho21v7 + hCoeffs->rho21v7S)
                        + (hCoeffs->rho21v7l + hCoeffs->rho21v7lS)* eulerlogxabs 
			+ v*(hCoeffs->rho21v8 + hCoeffs->rho21v8l * eulerlogxabs 
			+ (hCoeffs->rho21v10 + hCoeffs->rho21v10l * eulerlogxabs)*v2))))))));
                auxflm = v*(hCoeffs->f21v1 + hCoeffs->f21v1S) + v2*v*hCoeffs->f21v3;
                }
	        break;
	      default:
                XLAL_ERROR( XLAL_EINVAL );
	  ...
	  case 3:
	    ...
	    {
	      case 3:
	        deltalm = vh3*(hCoeffs->delta33vh3 
                        + vh3*((hCoeffs->delta33vh6 + hCoeffs->delta33vh6S)
                        + hCoeffs->delta33vh9*vh3)) 
                        + hCoeffs->delta33v5*v*v2*v2 + hCoeffs->delta33v7*v2*v2*v2*v;
		rholm	= 1. + v2*(hCoeffs->rho33v2 + v*(hCoeffs->rho33v3 
                        + v*((hCoeffs->rho33v4 + hCoeffs->rho33v4S)
			+ v*((hCoeffs->rho33v5 + hCoeffs->rho33v5S)
                        + v*((hCoeffs->rho33v6 + hCoeffs->rho33v6S)
                        + hCoeffs->rho33v6l*eulerlogxabs
			+ v*((hCoeffs->rho33v7 + hCoeffs->rho33v7S)
                        + (hCoeffs->rho33v8 
                        + hCoeffs->rho33v8l*eulerlogxabs)*v))))));
                auxflm = v*v2*(hCoeffs->f33v3 + hCoeffs->f33v3S);
	        break;
	      case 2:
		deltalm = vh3*(hCoeffs->delta32vh3 
                        + vh*((hCoeffs->delta32vh4 + hCoeffs->delta32vh4S)
                        + vh*vh*((hCoeffs->delta32vh6 + hCoeffs->delta32vh6S)
			+ hCoeffs->delta32vh9*vh3)));
		rholm	= 1. + v*((hCoeffs->rho32v + hCoeffs->rho32vS)
			+ v*((hCoeffs->rho32v2 + hCoeffs->rho32v2S)
                        + v*((hCoeffs->rho32v3 + hCoeffs->rho32v3S)
                        + v*((hCoeffs->rho32v4 + hCoeffs->rho32v4S)
                        + v*((hCoeffs->rho32v5 + hCoeffs->rho32v5S)
			+ v*((hCoeffs->rho32v6 + hCoeffs->rho32v6S)
                        + hCoeffs->rho32v6l*eulerlogxabs 
                        + (hCoeffs->rho32v8 
                        + hCoeffs->rho32v8l*eulerlogxabs)*v2))))));
		break;
	      case 1:
		deltalm = vh3*(hCoeffs->delta31vh3 
                        + vh3*((hCoeffs->delta31vh6 + hCoeffs->delta31vh6S)
			+ vh*((hCoeffs->delta31vh7 + hCoeffs->delta31vh7S)
                        + hCoeffs->delta31vh9*vh*vh))) 
			+ hCoeffs->delta31v5*v*v2*v2;
		rholm	= 1. + v2*(hCoeffs->rho31v2 + v*(hCoeffs->rho31v3 
                        + v*((hCoeffs->rho31v4 + hCoeffs->rho31v4S)
			+ v*((hCoeffs->rho31v5 + hCoeffs->rho31v5S)
                        + v*((hCoeffs->rho31v6 + hCoeffs->rho31v6S)
                        + hCoeffs->rho31v6l*eulerlogxabs 
			+ v*((hCoeffs->rho31v7 + hCoeffs->rho31v7S)
                        + (hCoeffs->rho31v8 
                        + hCoeffs->rho31v8l*eulerlogxabs)*v))))));
                auxflm = v*v2*(hCoeffs->f31v3 + hCoeffs->f31v3S);
		break;
              default:
                XLAL_ERROR( XLAL_EINVAL );
                break;
	  ...
	  case 4:
	    switch (m)
	    {
	      case 4:
	        ...
	        deltalm = vh3*(hCoeffs->delta44vh3 
                        + (hCoeffs->delta44vh6 + hCoeffs->delta44vh6S)*vh3)
                        + hCoeffs->delta44v5*v2*v2*v;
		rholm	= 1. + v2*(hCoeffs->rho44v2
			+ v*((hCoeffs->rho44v3 + hCoeffs->rho44v3S)
                        + v*((hCoeffs->rho44v4 + hCoeffs->rho44v4S)
			+ v*((hCoeffs->rho44v5 + hCoeffs->rho44v5S)
                        + ((hCoeffs->rho44v6 + hCoeffs->rho44v6S)
			+ hCoeffs->rho44v6l*eulerlogxabs)*v))));
	        break;
	      case 3:
	        deltalm = vh3*(hCoeffs->delta43vh3 
                        + vh*((hCoeffs->delta43vh4 + hCoeffs->delta43vh4S)
			+ hCoeffs->delta43vh6*vh*vh));
		rholm	= 1. + v*(hCoeffs->rho43v
			+ v*(hCoeffs->rho43v2
			+ v2*((hCoeffs->rho43v4 + hCoeffs->rho43v4S)
                        + v*((hCoeffs->rho43v5 + hCoeffs->rho43v5S)
			+ (hCoeffs->rho43v6 + hCoeffs->rho43v6l*eulerlogxabs)*v))));
                auxflm = v*(hCoeffs->f43v + hCoeffs->f43vS);
	        break;
	      case 2:
		deltalm = vh3*(hCoeffs->delta42vh3 
                        + (hCoeffs->delta42vh6 + hCoeffs->delta42vh6S)*vh3);
		rholm	= 1. + v2*(hCoeffs->rho42v2
			+ v*((hCoeffs->rho42v3 + hCoeffs->rho42v3S)
                        + v*((hCoeffs->rho42v4 + hCoeffs->rho42v4S)
                        + v*((hCoeffs->rho42v5 + hCoeffs->rho42v5S)
			+ ((hCoeffs->rho42v6 + hCoeffs->rho42v6S)
                        + hCoeffs->rho42v6l*eulerlogxabs)*v))));
		break;
	      case 1:
		deltalm = vh3*(hCoeffs->delta41vh3 
                        + vh*((hCoeffs->delta41vh4 + hCoeffs->delta41vh4S)
			+ hCoeffs->delta41vh6*vh*vh));
		rholm	= 1. + v*(hCoeffs->rho41v 
			+ v*(hCoeffs->rho41v2
			+ v2*((hCoeffs->rho41v4 + hCoeffs->rho41v4S)
                        + v*((hCoeffs->rho41v5 + hCoeffs->rho41v5S)
			+ (hCoeffs->rho41v6 +  hCoeffs->rho41v6l*eulerlogxabs)*v))));
                auxflm = v*(hCoeffs->f41v + hCoeffs->f41vS);
		break;
	      default:
                XLAL_ERROR( XLAL_EINVAL );
                break;
	  ...
	  case 5:
		...
		rholm	= 1. + v2*( hCoeffs->rho55v2 
			+ v*((hCoeffs->rho55v3 + hCoeffs->rho55v3S)
                        + v*((hCoeffs->rho55v4 + hCoeffs->rho55v4S)
                        + v*((hCoeffs->rho55v5 + hCoeffs->rho55v5S)
                        + hCoeffs->rho55v6*v))));
	        break;
	      case 4:
		deltalm = vh3*(hCoeffs->delta54vh3 
                        + (hCoeffs->delta54vh4 + hCoeffs->delta54vh4S)*vh);
		rholm	= 1. + v2*(hCoeffs->rho54v2 
                        + v*((hCoeffs->rho54v3 + hCoeffs->rho54v3S)
			+ (hCoeffs->rho54v4 + hCoeffs->rho54v4S)*v));
		break;
	      case 3:
	        deltalm = hCoeffs->delta53vh3 * vh3;
		rholm	= 1. + v2*(hCoeffs->rho53v2 
			+ v*((hCoeffs->rho53v3 + hCoeffs->rho53v3S)
                        + v*((hCoeffs->rho53v4 + hCoeffs->rho53v4S)
                        + (hCoeffs->rho53v5 + hCoeffs->rho53v5S)*v)));
	        break;
	      case 2:
		deltalm = vh3*(hCoeffs->delta52vh3 
                        + (hCoeffs->delta52vh4 + hCoeffs->delta52vh4S)*vh);
		rholm	= 1. + v2*(hCoeffs->rho52v2 
                        + v*((hCoeffs->rho52v3 + hCoeffs->rho52v3S)
			+ (hCoeffs->rho52v4 + hCoeffs->rho52v4S)*v));
		break;
	      case 1:
		deltalm = hCoeffs->delta51vh3 * vh3;
		rholm	= 1. + v2*(hCoeffs->rho51v2 
			+ v*((hCoeffs->rho51v3 + hCoeffs->rho51v3S)
                        + v*((hCoeffs->rho51v4 + hCoeffs->rho51v4S)
                        + (hCoeffs->rho51v5 + hCoeffs->rho51v5S)*v)));
		break;
	      default:
                XLAL_ERROR( XLAL_EINVAL );
                break;
	  ...
	  case 6:
		...
		rholm	= 1. + v2*(hCoeffs->rho66v2 
                        + v*((hCoeffs->rho66v3 + hCoeffs->rho66v3S)
			+ (hCoeffs->rho66v4 + hCoeffs->rho66v4S)*v));
	        break;
	      case 5:
		deltalm = hCoeffs->delta65vh3*vh3;
		rholm	= 1. + v2*(hCoeffs->rho65v2 
                        + (hCoeffs->rho65v3 + hCoeffs->rho65v3S)*v);
		break;
	      case 4:
		deltalm = hCoeffs->delta64vh3 * vh3;
		rholm	= 1. + v2*(hCoeffs->rho64v2 
                        + v*((hCoeffs->rho64v3 + hCoeffs->rho64v3S)
			+ (hCoeffs->rho64v4 + hCoeffs->rho64v4S)*v));
		break;
	      case 3:
	        deltalm = hCoeffs->delta63vh3 * vh3;
		rholm	= 1. + v2*(hCoeffs->rho63v2 
                        + (hCoeffs->rho63v3 + hCoeffs->rho63v3S)*v);
	        break;
	      case 2:
	  ...
	  case 7:
		...
		rholm	= 1. + v2*(hCoeffs->rho77v2 
                        + (hCoeffs->rho77v3 + hCoeffs->rho77v3S)* v);
	        break;
	      case 6:
	        deltalm = 0.0;
		...
		rholm	= 1. + v2*(hCoeffs->rho75v2 
                        + (hCoeffs->rho75v3 + hCoeffs->rho75v3S)*v);
		break;
	      case 4:
		deltalm = 0.0;
		...
		rholm	= 1. + v2*(hCoeffs->rho73v2 
                        + (hCoeffs->rho73v3 + hCoeffs->rho73v3S)* v);
	        break;
	      case 2:
		deltalm = 0.0;
		...
		rholm	= 1. + v2*(hCoeffs->rho71v2 
                        + (hCoeffs->rho71v3 + hCoeffs->rho71v3S)* v);
		break;
	      default:
                XLAL_ERROR( XLAL_EINVAL );
                break;
                 ...
                 )
{
  ...
  if(debugPK)printf("Tlm = %e + i%e, |Tlm| = %.16e (should be %.16e)\n", creal(Tlm), cimag(Tlm), cabs(Tlm), Tlmold);
	...
	switch( l )
	{
	  ...
	  default:
        ...
        // debugPK
        if(debugPK)printf("rho_%d_%d = %.12e \n", l, m, rholm);
        if(debugPK)printf("exp(delta_%d_%d) = %.16e + i%.16e (abs=%e)\n", l, m, creal(cexp(I * deltalm)),
          ...
          )
{
  ...
  coeffs->rho22v2   = -43./42. + (55.*eta)/84.;
  coeffs->rho22v3   = 0.;//(-2.*(chiS + chiA*dM - chiS*eta))/3.;
  switch ( SpinAlignedEOBversion )
  {
     case 1:
       coeffs->rho22v4   = -20555./10584. //+ 0.5*a2 
  ...
  if ( dM2 )
  {
    ...
    switch ( SpinAlignedEOBversion )
    {
      case 1:
        coeffs->rho21v2   = -59./56 + (23.*eta)/84.;// - 9./32.*a2;
        coeffs->rho21v3   = 0.;//1177./672.*a - 27./128.*a3;
        break;
      case 2:
        coeffs->rho21v2   = -59./56 + (23.*eta)/84.;
        coeffs->rho21v3   = 0.0;
    ...
    coeffs->rho21v4   = - 47009./56448./*- (865.*a2)/1792. - (405.*a2*a2)/2048.*/
                        - (10993.*eta)/14112.
                        + (617.*eta2)/4704.;
    coeffs->rho21v5   = 0.;//(-98635.*a)/75264. + (2031.*a*a2)/7168. - (1701.*a2*a3)/8192.;
    coeffs->rho21v6   = 7613184941./2607897600.;//+ (9032393.*a2)/1806336. + (3897.*a2*a2)/16384. - (15309.*a3*a3)/65536.; 
    coeffs->rho21v6l  = - 107./105.;
    coeffs->rho21v7   = 0.;//(-3859374457.*a)/1159065600. - (55169.*a3)/16384.
                        //+ (18603.*a2*a3)/65536. - (72171.*a2*a2*a3)/262144.;
    coeffs->rho21v7l  =  0.;//107.*a/140.;
    coeffs->rho21v8   = -1168617463883./911303737344.;
    coeffs->rho21v8l  = 6313./5880.;
    coeffs->rho21v10  = -63735873771463./16569158860800.; 
    coeffs->rho21v10l = 5029963./5927040.;

    coeffs->f21v1     = 0.;//(-3.*(chiS+chiA/dM))/(2.);
    switch ( SpinAlignedEOBversion )
    {
      case 1:
        coeffs->f21v3   = 0.0;
  ...
  {
    coeffs->f21v1     = 0.;//-3.*chiA/2.;
    coeffs->f21v3     = 0.;//(chiS*dM*(427.+79.*eta)+chiA*(147.+280.*dM*dM+1251.*eta))/84.;
  }
  ...
  if ( dM2 )
  {
    ...
    coeffs->rho33v3 = 0.0;
    coeffs->rho33v4 = -6719./3960. /*+ a2/2.*/ - (1861.*eta)/990. + (149.*eta2)/330.;
    coeffs->rho33v5 = 0.;//(-4.*a)/3.;
    coeffs->rho33v6 = 3203101567./227026800.;// + (5.*a2)/36.;
    coeffs->rho33v6l = - 26./7.;
    coeffs->rho33v7 = 0.;//(5297.*a)/2970. + a*a2/3.;
    coeffs->rho33v8 = -57566572157./8562153600.;
    coeffs->rho33v8l = 13./3.;

    coeffs->f33v3 = 0.;//(chiS*dM*(-4. + 5.*eta) + chiA*(-4. + 19.*eta))/(2.*dM);
  }
  else
  {
    coeffs->f33v3 = 0.;//chiA * 3./8.;
  }

  coeffs->delta32vh3 = (10. + 33.*eta)/(-15.*m1Plus3eta);
  coeffs->delta32vh4 = 0.;//4.*a;
  coeffs->delta32vh6 = /*(-136.*a)/45. +*/ (52.*LAL_PI)/21.;
  coeffs->delta32vh9 = -9112./405. + (208.*LAL_PI*LAL_PI)/63.;

  coeffs->rho32v   = 0.;//(4.*chiS*eta)/(-3.*m1Plus3eta);
  coeffs->rho32v2  = /*(-4.*a2*eta2)/(9.*m1Plus3eta2) +*/ (328. - 1115.*eta
                        + 320.*eta2)/(270.*m1Plus3eta);
  coeffs->rho32v3  = 0.;//(2.*(45.*a*m1Plus3eta3
                        //- a*eta*(328. - 2099.*eta + 5.*(733. + 20.*a2)*eta2
                        //- 960.*eta3)))/(405.*m1Plus3eta3);
  coeffs->rho32v4  = /*a2/3. +*/ (-1444528.
                        + 8050045.*eta - 4725605.*eta2 - 20338960.*eta3
                        + 3085640.*eta2*eta2)/(1603800.*m1Plus3eta2);
  coeffs->rho32v5  = 0.;//(-2788.*a)/1215.;
  coeffs->rho32v6  = 5849948554./940355325.;// + (488.*a2)/405.;
  coeffs->rho32v6l =  - 104./63.;
  coeffs->rho32v8  = -10607269449358./3072140846775.;
  coeffs->rho32v8l = 17056./8505.;
  ...
  if ( dM2 )
  {
    ...
    coeffs->rho31v5  = 0.;//(4.*a)/9.;
    coeffs->rho31v6  = 11706720301./6129723600.;// - (49.*a2)/108.;
    coeffs->rho31v6l =  - 26./63.;
    coeffs->rho31v7  = 0.;//(-2579.*a)/5346. + a*a2/9.;
    coeffs->rho31v8  = 2606097992581./4854741091200.;
    coeffs->rho31v8l = 169./567.;

    coeffs->f31v3  = 0.;//(chiA*(-4. + 11.*eta) + chiS*dM*(-4. + 13.*eta))/(2.*dM);
  }
  else
  {
    coeffs->f31v3  = 0.;//- chiA * 5./8.;
  }
  ...
  coeffs->rho44v2 = (1614. - 5870.*eta + 2625.*eta2)/(1320.*m1Plus3eta);
  coeffs->rho44v3 = 0.;//(chiA*(10. - 39.*eta)*dM + chiS*(10. - 41.*eta
                       // + 42.*eta2))/(15.*m1Plus3eta);
  coeffs->rho44v4 = /*a2/2. +*/ (-511573572.
                        + 2338945704.*eta - 313857376.*eta2 - 6733146000.*eta3
                        + 1252563795.*eta2*eta2)/(317116800.*m1Plus3eta2);
  coeffs->rho44v5 = 0.;//(-69.*a)/55.;
  coeffs->rho44v6 = 16600939332793./1098809712000.;// + (217.*a2)/3960.;
  coeffs->rho44v6l = - 12568./3465.;
  ...
  if ( dM2 )
  {
    ...
    coeffs->rho43v2  = (222. - 547.*eta + 160.*eta2)/(176.*(-1. + 2.*eta));
    coeffs->rho43v4  = -6894273./7047040.;// + (3.*a2)/8.;
    coeffs->rho43v5  = 0.;//(-12113.*a)/6160.;
    coeffs->rho43v6  = 1664224207351./195343948800.;
    coeffs->rho43v6l = - 1571./770.;

    coeffs->f43v   = 0.;//(5.*(chiA - chiS*dM)*eta)/(2.*dM*(-1. + 2.*eta));
  }
  else
  {
    coeffs->f43v   = 0.;//- 5.*chiA/4.;
  }
  ...
  coeffs->rho42v2  = (1146. - 3530.*eta + 285.*eta2)/(1320.*m1Plus3eta);
  coeffs->rho42v3  = 0.;//(chiA*(10. - 21.*eta)*dM + chiS*(10. - 59.*eta
                        //+ 78.*eta2))/(15.*m1Plus3eta);
  coeffs->rho42v4  = /*a2/2. +*/ (-114859044. + 295834536.*eta + 1204388696.*eta2 - 3047981160.*eta3
                        - 379526805.*eta2*eta2)/(317116800.*m1Plus3eta2);
  coeffs->rho42v5  = 0.;//(-7.*a)/110.;
  coeffs->rho42v6  = 848238724511./219761942400.;// + (2323.*a2)/3960.;
  coeffs->rho42v6l = - 3142./3465.;
  ...
  if ( dM2 )
  {
    ...
    coeffs->rho41v2  = (602. - 1385.*eta + 288.*eta2)/(528.*(-1. + 2.*eta));
    coeffs->rho41v4  = -7775491./21141120.;// + (3.*a2)/8.;
    coeffs->rho41v5  = 0.;//(-20033.*a)/55440. - (5*a*a2)/6.;
    coeffs->rho41v6  = 1227423222031./1758095539200.;
    coeffs->rho41v6l = - 1571./6930.;

    coeffs->f41v = 0.;//(5.*(chiA - chiS*dM)*eta)/(2.*dM*(-1. + 2.*eta));
  }
  else
  {
    coeffs->f41v = 0.;//- 5.*chiA/4.;
  }
  ...
  if ( dM2 )
  {
    ...
    coeffs->rho55v2 = (487. - 1298.*eta + 512.*eta2)/(390.*(-1. + 2.*eta));
    coeffs->rho55v3 = 0.;//(-2.*a)/3.;
    coeffs->rho55v4 = -3353747./2129400.;// + a2/2.;
    coeffs->rho55v5 = 0.;//- 241. * a / 195.;
  }

  coeffs->delta54vh3 = 8./15.;
  coeffs->delta54vh4 = 0.;//12.*a/5.;

  coeffs->rho54v2 = (-17448. + 96019.*eta - 127610.*eta2
                        + 33320.*eta3)/(13650.*(1. - 5.*eta + 5.*eta2));
  coeffs->rho54v3 = 0.;//(-2.*a)/15.;
  coeffs->rho54v4 = -16213384./15526875.;// + (2.*a2)/5.;
  ...
  if ( dM2 )
  {
    ...
    coeffs->rho53v2 = (375. - 850.*eta + 176.*eta2)/(390.*(-1. + 2.*eta));
    coeffs->rho53v3 = 0.;//(-2.*a)/3.;
    coeffs->rho53v4 = -410833./709800.;// + a2/2.;
    coeffs->rho53v5 = 0.;//- 103.*a/325.;
  }

  coeffs->delta52vh3 = 4./15.;
  coeffs->delta52vh4 = 0.;//6.*a/5.;

  coeffs->rho52v2 = (-15828. + 84679.*eta - 104930.*eta2
                        + 21980.*eta3)/(13650.*(1. - 5.*eta + 5.*eta2));
  coeffs->rho52v3 = 0.;//(-2.*a)/15.;
  coeffs->rho52v4 = -7187914./15526875.;// + (2.*a2)/5.;
  ...
  if ( dM2 )
  {
    ...
    coeffs->rho51v2 = (319. - 626.*eta + 8.*eta2)/(390.*(-1. + 2.*eta));
    coeffs->rho51v3 = 0.;//(-2.*a)/3.;
    coeffs->rho51v4 = -31877./304200.;// + a2/2.;
    coeffs->rho51v5 = 0.;//139.*a/975.;
  }
          ...
          )
{
  ...
  {
     case 1:
       coeffs->rho22v8S   = /*eta*(-5.6-117.6*eta) -387216563023./160190110080. +*/ (18353.*a2)/21168. - a2*a2/8.;
       break;
     case 2:
  ...
  {
    //coeffs->delta21vh3 = 2./3.;
    coeffs->delta21vh6S = (-17.*a)/35.; //+ (107.*LAL_PI)/105.;
  ...
  {
    //coeffs->delta33vh3 = 13./10.;
    coeffs->delta33vh6S = (-81.*a)/20.;// + (39.*LAL_PI)/7.;
    //coeffs->delta33vh9 = -227827./3000. + (78.*LAL_PI*LAL_PI)/7.;
    //coeffs->delta33v5  = - 80897.*eta / 2430.;
    ...
    //coeffs->rho33v3 = (chiS*dM*(-4. + 5.*eta) + chiA*(-4. + 19.*eta))/(6.*dM);
    //coeffs->rho33v3 = 0.0;
    coeffs->rho33v4S = /*-6719./3960. +*/ a2/2.;// - (1861.*eta)/990. + (149.*eta2)/330.;
  ...
  coeffs->delta32vh6S = (-136.*a)/45.;// + (52.*LAL_PI)/21.;
  //coeffs->delta32vh9 = -9112./405. + (208.*LAL_PI*LAL_PI)/63.;
  ...
  {
    //coeffs->delta31vh3 = 13./30.;
    coeffs->delta31vh6S = (61.*a)/20.;// + (13.*LAL_PI)/21.;
  ...
  //coeffs->delta44vh3 = (112. + 219.*eta)/(-120.*m1Plus3eta);
  coeffs->delta44vh6S = (-464.*a)/75.;// + (25136.*LAL_PI)/3465.;

  //coeffs->rho44v2 = (1614. - 5870.*eta + 2625.*eta2)/(1320.*m1Plus3eta);
  coeffs->rho44v3S = (chiA*(10. - 39.*eta)*dM + chiS*(10. - 41.*eta
                        + 42.*eta2))/(15.*m1Plus3eta);
  coeffs->rho44v4S = a2/2.;// + (-511573572.
                        //+ 2338945704.*eta - 313857376.*eta2 - 6733146000.*eta3
                        //+ 1252563795.*eta2*eta2)/(317116800.*m1Plus3eta2);
  ...
  //coeffs->delta42vh3 = (7.*(1. + 6.*eta))/(-15.*m1Plus3eta);
  coeffs->delta42vh6S = (212.*a)/75.;// + (6284.*LAL_PI)/3465.;

  //coeffs->rho42v2  = (1146. - 3530.*eta + 285.*eta2)/(1320.*m1Plus3eta);
  coeffs->rho42v3S  = (chiA*(10. - 21.*eta)*dM + chiS*(10. - 59.*eta
                        + 78.*eta2))/(15.*m1Plus3eta);
  coeffs->rho42v4S  = a2/2.;// + (-114859044. + 295834536.*eta + 1204388696.*eta2 - 3047981160.*eta3
                       // - 379526805.*eta2*eta2)/(317116800.*m1Plus3eta2);
...
/* The following functions are to be used by the SEOBNRv3 waveform generation.
 * Including a function to be used for flux calculation.
 * */
